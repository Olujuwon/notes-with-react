...
const LoginPage:React.FC<object> = () => {
    ...
    return(
        <form className={`flex flex-col gap-y-3 place-content-center justify-center py-[50%]`} onSubmit={handleLoginUser}>
            ...
            <Link className={`mx-auto mt-4 cursor-pointer text-[color:var(--color-dark)]`} to='/auth/register'>Not registered? Register here</Link>
        </form>
    )
}
